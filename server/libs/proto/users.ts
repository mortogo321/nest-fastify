...
export const User: MessageFns<User> = {
  encode(message: User, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.subscribed !== false) {
      writer.uint32(24).bool(message.subscribed);
    }
    if (message.socialMedia !== undefined) {
      SocialMedia.encode(message.socialMedia, writer.uint32(34).fork()).join();
    }
    return writer;
  },
...
function createBaseSocialMedia(): SocialMedia {
  return { facebookUri: undefined, twitterUri: undefined };
}
...
export const SocialMedia: MessageFns<SocialMedia> = {
  encode(message: SocialMedia, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.facebookUri !== undefined) {
      writer.uint32(10).string(message.facebookUri);
    }
    if (message.twitterUri !== undefined) {
      writer.uint32(18).string(message.twitterUri);
    }
    return writer;
  },
  ...
  fromJSON(object: any): SocialMedia {
    return {
      facebookUri: isSet(object.facebookUri) ? globalThis.String(object.facebookUri) : undefined,
  ...
  toJSON(message: SocialMedia): unknown {
    const obj: any = {};
    if (message.facebookUri !== undefined) {
      obj.facebookUri = message.facebookUri;
    }
    if (message.twitterUri !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<SocialMedia>, I>>(object: I): SocialMedia {
    const message = createBaseSocialMedia();
    message.facebookUri = object.facebookUri ?? undefined;
...
export const UsersServiceServiceName = "USER.UsersService";
